...
public class SuministraListarAction implements ActionListener {

	private vistaSwing ventana;
	private modelo modelo = new modelo();

	public SuministraListarAction(vistaSwing ventana) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		try {
			result = vista.resultSelectSuministra(modelo.listrarSuministra());
